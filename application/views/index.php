...
<html>
	<head>
		...
		<!--///////////////////////////   Styles   ///////////////////////////-->
		<link rel='stylesheet' href='assets/css/camera_slider/camera.css' type='text/css' media='all'>
		...
		<link rel="stylesheet" href="assets/css/owl_carousel/owl.theme.css">
		<link rel="stylesheet" href="assets/css/bootstrap/carousel.css" />
		<link rel="stylesheet" href="assets/css/font_awesome/font-awesome.min.css" />
		...
		<!--///////////////////////////   Scripts   ///////////////////////////-->
		<script type='text/javascript' src='assets/js/jquery_1.11.0.min.js'></script>		
		<script type="text/javascript" src="assets/js/jquery.snow.min.1.0.js"></script>
		<script type='text/javascript' src='assets/js/jquery.easing.1.3.js'></script>
		<script type='text/javascript' src='assets/js/camera_slider/camera.js'></script>
		<script type="text/javascript" src="assets/js/bootstrap/bootstrap.min.js"></script>
		<script type="text/javascript" src="assets/js/owl_carousel/owl.carousel.min.js"></script>
				...
				<nav class="navbar navbar-default navbar-static-top nav-custom" role="navigation" >
					<div class="container">
						<div class="navbar-header" style="height: 75px;">
							...
							<a href="#" class="navbar-brand brand-custom"><img src="assets/images/ics_logo_new.svg" height="75" /></a>
						</div>
						...
						<div class="collapse navbar-collapse collapse-custom">
							...
							<ul class="nav navbar-nav navbar-right">
								<li>
									<a href="#" id="home" class="selected"><?php echo $menus_home; ?></a>
								</li>
								<li class="dropdown">									
								...
								<li class="last">
									<a href="#" id="kontakt"><?php echo $menus_contact; ?></a>
								</li>
							</ul>
						</div>
					</div>
						...
						<div class="item">
							...
							<p>
								<button type="button" class="btn btn-default">
									<?php echo $additional_button_more; ?>
								</button>
							</p>
						</div>
						<div class="item">
							<img class="img-rounded" src="assets/images/fiber_optic.jpg" />
							<h2>Успешна приказна 2 :
							<br />
							Март 2010</h2>
							<p>
								ИЦС Консалтинг и Инженеринг успешно инсталираше опрема за ИМС проектот за Македонски Телеком
					...
					<div class="row">
						...
						<div class="col-md-12 social-btn">
							<ul class="social-media">
								...
								<li class="go-up-logo">
									<a href="#" class="back-to-top"> <img src="assets/images/ics-logo-malo1.svg" class="top" style="height: 60px;width: 60px;" /> <img src="assets/images/arrow_up.svg" class="bottom" style="height: 60px;width: 60px;" /> </a>
								</li>
								<li>
