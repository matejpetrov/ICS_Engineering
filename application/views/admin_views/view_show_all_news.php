					...
					<tbody class="table-body">
						...
						<?php foreach($all_news as $key => $value){
							...
							<tr class="table-row" id="<?php echo $key; ?>">
								...
								<td>					
									<a href="<?php echo base_url() . "admin/show_news/" . $key; ?>" class="btn btn-primary tbtn">Preview</a></br>
									<a href="<?php echo base_url() . "admin/edit_news/" . $key; ?>" class="btn btn-default tbtn edit">Edit</a></br>
									<a href="#" class="btn btn-danger delete-link tbtn" data-toggle="modal" data-target="#modalDelete">Delete</a></br>
								</td>
							</tr>
